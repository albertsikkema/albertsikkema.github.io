...
image: /assets/images/the-gap-is-not-that-wide-blog.png
---
...
Every time I read that Europe will "never catch up" in AI, it annoys me. The distance is too large, the gap is permanent, we should just accept American dominance and move on. I keep hearing it from commentators, from tech media, from people who should know better.
...
- Anthropic went from "ChatGPT knockoff" to having models [restricted by the US government](https://fortune.com/2026/06/13/anthropic-disables-fable-mythos-export-controls-national-security-threat/) in three years
- DeepSeek went from unknown to [shaking markets](https://api-docs.deepseek.com/news/news250120) in about a year
- [Mistral](https://mistral.ai/) went from a French startup to a model provider aiming to compete with the big three
...
I [wrote earlier today](/ai/opinion/cloud/2026/06/28/the-third-option-for-enterprise-ai.html) about European cloud providers running open-source models as a practical alternative to US hyperscalers. That post was about the solution. This one is about the fear that makes people think they do not need one: the idea that the race is already over.
...
*Working on AI strategy and wondering how the competitive field affects your choices? <a href="#" onclick="task1(); return false;">Get in touch</a> to compare notes.*

## Sources

- [Artificial Analysis LLM Leaderboard](https://artificialanalysis.ai/leaderboards/models) -- Independent model comparison, updated regularly
- [Fortune: Anthropic disables Fable/Mythos](https://fortune.com/2026/06/13/anthropic-disables-fable-mythos-export-controls-national-security-threat/) -- Export control whiplash
- [CNBC: Mythos 5 restrictions loosened](https://www.cnbc.com/2026/06/26/us-government-anthropic-claude-mythos5-ai.html) -- Two weeks later
- [AP News: AI data centres and water consumption](https://apnews.com/article/ai-data-centers-water-consumption-drought-arid-climate-f7f0727ca73f2b1e4ef2e51d90e45b0b) -- The resource cost of the spending race

## Related Posts

- [The Third Option for Enterprise AI](/ai/opinion/cloud/2026/06/28/the-third-option-for-enterprise-ai.html) -- The practical alternative to US hyperscalers
- [Why LLMs Will Not Have Your Next Big Idea](/ai/opinion/research/2026/06/24/why-llms-will-not-have-your-next-big-idea.html) -- More on separating hype from capability
